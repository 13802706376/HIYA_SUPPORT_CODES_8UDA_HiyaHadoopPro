...
import com.hiya.da.hadoop.mapper.HiyaMiddlePersonsCountMapper;
import com.hiya.da.hadoop.reduce.HiyaMiddlePersonsCountReduce;
 ...
 *
 */
public class HiyaMiddlePersonsCountRunner extends Configured implements Tool
{
	private static final Log hiyaLog =LogFactory.getLog("MiddlePersonsCountReduce");
	
	@Override
	public int run(String[] arg0) throws Exception
	{
		hiyaLog.info("MiddlePersonsCountRunner  start.....");
		// 实例化作业对象，设置作业名称、Mapper和Reduce类
		Job job = new Job(getConf(), "MiddlePersonsCount");
		job.setJobName("MiddlePersonsCount");
		job.setJarByClass(HiyaClient.class);
		job.setMapperClass(HiyaMiddlePersonsCountMapper.class);
		job.setReducerClass(HiyaMiddlePersonsCountReduce.class);
		...
		hiyaLog.info("MiddlePersonsCountRunner  end.....");
