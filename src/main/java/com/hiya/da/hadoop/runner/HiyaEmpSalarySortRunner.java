...
import com.hiya.da.hadoop.comparator.HiyaEmpSalarySortComparator;
import com.hiya.da.hadoop.mapper.HiyaEmpSalarySortMapper;
import com.hiya.da.hadoop.reduce.HiyaEmpSalarySortReduce;
 ...
 *
 */
public class HiyaEmpSalarySortRunner extends Configured implements Tool
{
	private static final Log hiyaLog =LogFactory.getLog("EmpSalarySortReduce");
	
	@Override
	public int run(String[] arg0) throws Exception
	{
		hiyaLog.info("EmpSalarySortRunner  start.....");
		// 实例化作业对象，设置作业名称、Mapper和Reduce类
		Job job = new Job(getConf(), "EmpSalarySort");
		job.setJobName("EmpSalarySort");
		job.setJarByClass(HiyaClient.class);
		job.setMapperClass(HiyaEmpSalarySortMapper.class);
		job.setSortComparatorClass(HiyaEmpSalarySortComparator.class);
		...
		hiyaLog.info("EmpSalarySortRunner  end.....");
