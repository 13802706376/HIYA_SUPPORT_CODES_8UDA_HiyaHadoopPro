...
import com.hiya.da.hadoop.mapper.HiyaSumCitySalaryMapper;
import com.hiya.da.hadoop.reduce.HiyaSumCitySalaryReduce;
 ...
 *
 */
public class HiyaSumCitySalaryRunner extends Configured implements Tool
{
	private static final Log hiyaLog =LogFactory.getLog("SumCitySalaryReduce");
	
	@Override
	public int run(String[] arg0) throws Exception
	{
		hiyaLog.info("SumCitySalaryRunner  start.....");
		// 实例化作业对象，设置作业名称、Mapper和Reduce类
		Job job = new Job(getConf(), "SumCitySalary");
		job.setJobName("SumCitySalary");
		job.setJarByClass(HiyaClient.class);
		job.setMapperClass(HiyaSumCitySalaryMapper.class);
		job.setReducerClass(HiyaSumCitySalaryReduce.class);
		...
		hiyaLog.info("SumCitySalaryRunner  end.....");
