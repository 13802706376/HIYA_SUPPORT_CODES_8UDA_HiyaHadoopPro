...
import com.hiya.da.hadoop.mapper.HiyaDeptEarliestEmpMapper;
import com.hiya.da.hadoop.reduce.HiyaDeptEarliestEmpReduce;
 ...
 *
 */
public class HiyaDeptEarliestEmpRunner extends Configured implements Tool
{
	private static final Log hiyaLog =LogFactory.getLog("DeptEarliestEmpReduce");
	
	@Override
	public int run(String[] arg0) throws Exception
	{
		hiyaLog.info("DeptEarliestEmpRunner  start.....");
		// 实例化作业对象，设置作业名称、Mapper和Reduce类
		Job job = new Job(getConf(), "DeptEarliestEmp");
		job.setJobName("DeptEarliestEmp");
		job.setJarByClass(HiyaClient.class);
		job.setMapperClass(HiyaDeptEarliestEmpMapper.class);
		job.setReducerClass(HiyaDeptEarliestEmpReduce.class);
		...
		hiyaLog.info("DeptEarliestEmpRunner  end.....");
