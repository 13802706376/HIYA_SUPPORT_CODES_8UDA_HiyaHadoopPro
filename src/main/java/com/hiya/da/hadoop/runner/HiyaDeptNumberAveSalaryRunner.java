...
import com.hiya.da.hadoop.mapper.HiyaDeptNumberAveSalaryMapper;
import com.hiya.da.hadoop.reduce.HiyaDeptNumberAveSalaryReduce;
 ...
 *
 */
public class HiyaDeptNumberAveSalaryRunner extends Configured implements Tool
{
	private static final Log hiyaLog =LogFactory.getLog("DeptNumberAveSalaryReduce");
	
	@Override
	public int run(String[] arg0) throws Exception
	{
		hiyaLog.info("DeptNumberAveSalaryRunner  start.....");
		// 实例化作业对象，设置作业名称、Mapper和Reduce类
		Job job = new Job(getConf(), "DeptNumberAveSalary");
		job.setJobName("DeptNumberAveSalary");
		job.setJarByClass(HiyaClient.class);
		job.setMapperClass(HiyaDeptNumberAveSalaryMapper.class);
		job.setReducerClass(HiyaDeptNumberAveSalaryReduce.class);
		...
		hiyaLog.info("DeptNumberAveSalaryRunner  end.....");
